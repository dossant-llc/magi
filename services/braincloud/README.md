...
ssh your-username@your-server.com 'pgrep -f "node server.js" && echo "✅ Running" || echo "❌ Stopped"'
```
...
# View logs
ssh your-username@your-server.com 'tail -f /home/your-username/your-server.com/braincloud/braincloud.log'
...
```bash
# Start service
ssh your-username@your-server.com 'cd /home/your-username/your-server.com/braincloud && nohup node server.js > braincloud.log 2>&1 &'

# Stop service
ssh your-username@your-server.com 'pkill -f "node server.js"'

# Restart service
ssh your-username@your-server.com 'pkill -f "node server.js"; sleep 2; cd /home/your-username/your-server.com/braincloud && nohup node server.js > braincloud.log 2>&1 &'
```
...
3. **Monitor**: `ssh your-username@your-server.com 'tail -f /home/your-username/your-server.com/braincloud/braincloud.log'`
